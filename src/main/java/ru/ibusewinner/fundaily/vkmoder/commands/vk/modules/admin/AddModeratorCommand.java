...
public class AddModeratorCommand implements ICommand {
    @Override
    public void executeCommand(VkUserItem executor, Message message, List<String> args) {
        try {
            ...
            targetUser.setStatus(UserStatuses.MODERATOR);
    ...
    public List<String> getAliases() {
        return List.of("addmoder","+moder","выдатьмодера","выдатьмодератора","+модер","+модератор","+мод","+mod");
    }
